if not SkillOverhaul then
    ...
    SkillOverhaul.Hooks = {
        ...
        ["lib/tweak_data/weapontweakdata"] = "lua/weapontweakdata.lua",
        ...
        ["lib/units/equipment/sentry_gun/sentrygunbrain"] = "lua/units/sentrygunbrain.lua",
        ["lib/units/equipment/sentry_gun/sentrygundamage"] = "lua/units/sentrygundamage.lua",
        ["lib/units/weapons/sentrygunweapon"] = "lua/units/sentrygunweapon.lua",
...
Hooks:Add("MenuManagerInitialize", "SkillOVerhaul_MenuManagerInitialize", function(menu_manager)
    ...
    MenuCallbackHandler.callback_skilloverhaul_armoroverhaul_toggle = function(self, item)
        SkillOverhaul.MenuData.SkillArmorOverhaul = (item:value() == "on" and true or false)
        SkillOverhaul:SaveMenu()
    end
